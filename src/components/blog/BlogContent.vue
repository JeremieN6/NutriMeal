                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            <img class="mr-4 w-16 h-16 rounded-full object-cover" src="https://sassify.fr/calculateur-de-tjm/assets/moi-BYHfGxyY.webp"
                                alt="Jérémie N.">
                            <div>
                                <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">Jérémie N.</a>
                                <p class="text-base text-gray-500 dark:text-gray-400">Développeur, & CEO de - <i>JeremieCode Agency™</i></p>
